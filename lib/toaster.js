...
(function() {
  ...
  __t('toaster').Toast = (function() {
    ...
    Toast.prototype.toast = function(srcpath, params) {
      var alias, builder, config, debug, dir, folder, i, item, v, _i, _j, _len, _len1, _ref, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (params == null) {
        params = {};
      }
      ...
      config = {
        ...
        vendors_path: (_ref1 = params.vendors_path) != null ? _ref1 : "",
        exclude: (_ref2 = params.exclude) != null ? _ref2 : [],
        bare: (_ref3 = params.bare) != null ? _ref3 : false,
        packaging: (_ref4 = params.packaging) != null ? _ref4 : true,
        expose: (_ref5 = params.expose) != null ? _ref5 : null,
        minify: (_ref6 = params.minify) != null ? _ref6 : true,
        iced_runtime: (_ref7 = params.iced_runtime) != null ? _ref7 : 'node',
        httpfolder: (_ref8 = params.httpfolder) != null ? _ref8 : "",
        release: path.join(this.basepath, params.release),
        debug: debug
      };
      _ref9 = config.vendors;
      ...
      if (config.vendors_path !== "") {
        if ((path.resolve(config.vendors_path)) === !(path.join(this.basepath, config.vendors_path))) {
          config.vendors_path = path.resolve(config.vendors_path);
        } else {
          config.vendors_path = path.join(this.basepath, config.vendors_path);
        }
      } else {
      ...
      if (params.folders != null) {
        _ref10 = params.folders;
        for (folder in _ref10) {
          alias = _ref10[folder];
  ...
  __t('toaster.core').Script = (function() {
    ...
    Script.prototype.getinfo = function(declare_ns) {
      ...
      if (this.alias !== null) {
        this.filepath = path.join(this.alias, this.filepath);
      }
  ...
  __t('toaster.core').Builder = (function() {
    ...
    function Builder(toaster, cli, config) {
      ...
      this.vendor_changed = __bind(this.vendor_changed, this);

      this.build = __bind(this.build, this);

      this.vendors = this.config.vendors;
      this.vendors_path = this.config.vendors_path;
      this.bare = this.config.bare;
      this.iced_runtime = this.config.iced_runtime;
    ...
    Builder.prototype.watch = function() {
      var src, vendorWatcher, watcher, _i, _len, _ref1;
      this.watchers = [];
      _ref1 = this.config.src_folders;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        src = _ref1[_i];
      ...
      if (this.vendors_path !== void 0 && this.vendors_path !== "") {
        this.watchers.push((vendorWatcher = fsu.watch(this.vendors_path, /.js$/m)));
        vendorWatcher.on('create', FnUtil.proxy(this.vendor_changed, this.vendors_path, 'create'));
        vendorWatcher.on('change', FnUtil.proxy(this.vendor_changed, this.vendors_path, 'change'));
        return vendorWatcher.on('delete', FnUtil.proxy(this.vendor_changed, this.vendors_path, 'delete'));
      }
    };

    Builder.prototype.vendor_changed = function(src, ev, f) {
      var _this = this;
      return setTimeout(function() {
        ...
        if (_this.toaster.before_build === null || _this.toaster.before_build()) {
          return _this.build();
        }
      }, 500);
    };
    ...
    Builder.prototype.on_fs_change = function(src, ev, f) {
      var falias, fpath, include, item, spath, _i, _len, _ref1,
        _this = this;
      ...
      return setTimeout(function() {
        var file, msg, now, relative_path, s, type;
        ...
        switch (ev) {
          case "create":
            if (f.type === "file") {
              s = new Script(_this, spath, fpath, falias, _this.cli);
              _this.files.push(s);
            }
    ...
    Builder.prototype.compile = function() {
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        file = _ref1[_i];
        try {
          file.compiled = cs.compile(file.raw, {
            bare: this.bare,
            runtime: this.iced_runtime
          });
        } catch (err) {
    ...
    Builder.prototype.compile_for_debug = function() {
      var absolute_path, compiled, file, files, find, folder_path, index, relative_path, release_path, _i, _len, _ref1;
