...
(function() {
  ...
  __t('toaster').Toast = (function() {
    ...
    Toast.prototype.toast = function(srcpath, params) {
      var alias, builder, config, debug, dir, folder, i, item, v, _i, _j, _len, _len1, _ref, _ref1, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (params == null) {
        params = {};
      }
      ...
      config = {
        ...
        httpfolder: (_ref7 = params.httpfolder) != null ? _ref7 : "",
        release: path.join(this.basepath, params.release),
        debug: debug
      };
      _ref8 = config.vendors;
